                    ...
                    userProfile.linkedX && userProfile.linkedDiscord && userProfile.linkedTG && (
                        <div>
                            <div className="bg-main-blue/8 border border-solid border-main-blue/21 dark:bg-sec-bg dark:border-dark-stroke p-4 rounded-[10px]">
                                ...
                                <div className="flex flex-col gap-4 mt-4">
                                    <DailyTask checked={dailyAction.has(1)} done={"shared"} todo={"share"} link={'https://t.me/share/url?url=' + encodeURIComponent(currentUrl) + '&text=' + encodeURIComponent(tgText)} updateFunc={finishTask(71, 20, "Share Referral Link to TG", "Please confirm that you have shared referral link to TG")} text={"Share Referral Link to TG"} icon={<TwitterLogoIcon />} />
                                    <DailyTask checked={dailyAction.has(2)} done={"shared"} todo={"share"} link={"https://discord.com/invite/YG4Ydv2E7X"} updateFunc={() => finishTask(72, 20, "Share Referral Link to Discord", "Please confirm that you have shared referral link to Discord")} text={"Share Referral Link to Discord"} icon={<DiscordLogoIcon />} />
                                    <DailyTask checked={dailyAction.has(3)} done={"shared"} todo={"share"} link={'https://twitter.com/intent/tweet?text=' + encodeURIComponent(tweetText)} updateFunc={() => finishTask(73, 20, "Share Referral Link to X", "Please confirm that you have shared referral link to X")} text={"Share Referral Link to X"} icon={<TelegramLogoIconBW />} />
                                </div >
                            </div >
