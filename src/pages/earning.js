...
export default function Earnings () {
    ...
    return (
        <>
            ...
            { isVisible && <AlertCard image={"/Frame 34643-g.svg"} title={`+${points} Points`} text={text} size={87} closeFunc={ closeFunc } btn={"Back Tomorrow"} /> }
            ...
            <div className="flex flex-col gap-4 p-8 pb-32">
                ...
                <div className="bg-main-blue/8 border border-solid border-main-blue/21 dark:bg-sec-bg dark:border-dark-stroke p-4 rounded-[10px]">
                    ...
                    <div className="flex flex-col gap-4 mt-4">
                        <DailyTask updateFunc={ () => updateCard(20, "Share Referral Link to X", "Please confirm that you have shared referral link to X") } text={"Share Referral Link to X"} icon={ <TwitterLogoIcon /> } btn={"Link"} link={"https://x.com/MemoLabsOrg"} />
                        <DailyTask updateFunc={ () => updateCard(20, "Share Referral Link to TG", "Please confirm that you have shared referral link to TG") } text={"Share Referral Link to TG"} icon={ <TelegramLogoIconBW /> } btn={"Link"} link={"https://t.me/memolabsio"} />
                    </div>
                </div>
                ...
                <div className="bg-main-blue/8 border border-solid border-main-blue/21 dark:bg-sec-bg dark:border-dark-stroke p-4 rounded-[10px]">
                    ...
                    <div className="flex flex-col gap-4 mt-4">
                        <DailyTask updateFunc={ () => updateCard(20, "Share Referral Link to X", "Please confirm that you have shared referral link to X") } text={"Share Referral Link to X"} icon={ <TwitterLogoIcon /> } link={"https://twitter.com/intent/tweet?text=Join%20me%20on%20Modao!%20https%3A%2F%2Fmodao-alpha.vercel.app%2F"} />
                        <DailyTask updateFunc={ () => updateCard(20, "Share Referral Link to TG", "Please confirm that you have shared referral link to TG") } text={"Share Referral Link to TG"} icon={ <TelegramLogoIconBW /> } link={"https://t.me/share/url?url=https://modao-alpha.vercel.app/add-address/Gate.io&text=Join%20me%20on%20Modao"} />
                    </div>
                </div>
