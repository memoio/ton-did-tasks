            ...
            <div className="flex flex-col gap-4 p-8 pb-28">
                ...
                <div className="bg-main-blue/8 border border-solid border-main-blue/21 dark:bg-sec-bg dark:border-dark-stroke p-4 rounded-[10px]">
                    ...
                    <div className="flex flex-col gap-4 mt-4">
                        <DailyTask checked={userProfile.linkedX} done={"linked"} todo={"link"} updateFunc={() => handleXOauth()} text={"link X Account"} icon={<TwitterLogoIcon />} />
                        <DailyTask checked={userProfile.linkedDiscord} done={"linked"} todo={"link"} updateFunc={() => handleDiscordOauth()} text={"link Discord Account"} icon={<DiscordLogoIcon />} />
                    </div>
                </div>
