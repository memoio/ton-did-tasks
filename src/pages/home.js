        ...
        <>
            ...
            <div className="flex flex-col gap-4 p-8 pb-28">
                <div className="flex justify-between items-center">
                    <div className="flex gap-2 w-fit items-center">
                        ...
                        <div className="flex flex-col gap-0 relative top-0.5">
                            ...
                            <p className="text-dao-gray">did:memo:54tr...dfdd</p>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <HomeDoubleCard text={"Total Points"} amount={1000} icon={"/mdi_star-four-points-outline.svg"} link={"/points-details"} sze={22} shift={1} />
                    <HomeDoubleCard text={"Referral Made"} amount={10} icon={"/mdi_star-four-points-outline-xx.svg"} sze={18} link={"/invitation-details"} />
                </div>
