...
export default function Home() {
    ...
    const { dailyAction, finishAction } = useAction();
        ...
        <>
            ...
            <div className="flex flex-col gap-4 px-4 pt-8 pb-32">
                ...
                <div className="flex flex-col gap-4">
                    <HomeTripleCard icon={"/mdi_star-four-points-circle-outline.svg"} disabled={!didInfo.exist} title={"Points Earned Today"} amount={userInfo.todayPoints} text={"Check"} link={"/today-points-details"} />
                    ...
                    <HomeTripleCard icon={"/fa6-solid_ranking-star.svg"} disabled={!didInfo.exist} title={"My Rank"} amount={parseInt(userInfo.pointsRank) <= 100 ? userInfo.pointsRank : "100+"} text={"Check"} link={"/leaderboard"} />
                </div>
