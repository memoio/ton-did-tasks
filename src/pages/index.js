    ...
    return (
        <div className="min-h-screen max-h-screen w-full flex flex-col gap-8 items-center text-dao-yellow dark:text-white p-8">
            ...
            <div className="flex flex-col gap-4 w-full">
                ...
                <WalletConnectionCard id={3} elState={elState} fx={() => setElState(3)} image={"/free-coinbase-logo-icon-download-in-svg-png-gif-file-formats--web-crypro-trading-platform-logos-pack-icons-7651204 1.svg"} name={"Coinbase"} />
                <WalletConnectionCard id={4} elState={elState} fx={() => setElState(4)} image={"/google-wallet2132 1.svg"} name={"Browser Wallet"} />
            </div>
        </div>
    );
}