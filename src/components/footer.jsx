...
export function Footer ( props ) {
    return (
        <footer className="bg-white grid grid-cols-5 px-4 py-2 fixed bottom-0 pb-8 inset-x-4 z-30 gap-4 items-end dark:bg-white/5 dark:border dark:border-solid dark:border-white/10 dark:pb-2 dark:rounded-lg dark:bottom-6 backdrop-blur-xs">
